...
const GALERIE_BILDER = [
  ...
  // ---- Teichleben ----
  { id: 'teichleben-entchen1', kategorie: 'Teichleben', bild: 'bilder/teichleben/entchen1.jpg', alt: 'Entchen Nahaufnahme frontal', beschriftung: '<b>Entenküken</b> · Nahaufnahme', bereitsPostkarte: false },
  { id: 'teichleben-entchen2', kategorie: 'Teichleben', bild: 'bilder/teichleben/entchen2.jpg', alt: 'schlafendes Gänseküken neben Gänseblümchen', beschriftung: '<b>Gänseküken</b> · schlafend bei Gänseblümchen', bereitsPostkarte: false },
  { id: 'teichleben-entchen3', kategorie: 'Teichleben', bild: 'bilder/teichleben/entchen3.jpg', alt: 'zwei Entenküken am Ufer eines Teichs', beschriftung: '<b>Entenküken</b> · Sonnenbaden', bereitsPostkarte: false },
  { id: 'teichleben-ente1', kategorie: 'Teichleben', bild: 'bilder/teichleben/ente1.jpg', alt: 'Stockente breitet die Flügel auf dem Wasser aus', beschriftung: '<b>Stockente</b> · Flügelzauber', bereitsPostkarte: false },
  ...
  { id: 'teichleben-reiher2', kategorie: 'Teichleben', bild: 'bilder/teichleben/reiher2.jpg', alt: 'Reiher im Wasser stehend mit Grünschimmer', beschriftung: '<b>Reiher</b> · Frühlingsgrün', bereitsPostkarte: false },
  ...
  { id: 'gartenleben-kohlmeise1', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/kohlmeise1.jpg', alt: 'Kohlmeise im Grünen', beschriftung: '<b>Kohlmeise</b> · im Grünen', bereitsPostkarte: false },
  ...
  { id: 'gartenleben-zaunkoenig1', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/zaunkoenig1.jpg', alt: 'Zaunkönig im Gebüsch', beschriftung: '<b>Zaunkönig</b> · Höhen-Spagat', bereitsPostkarte: false },
  ...
  { id: 'gartenleben-schmetterling1', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/schmetterling1.jpg', alt: 'Schwanzmeise auf einem Zweig', beschriftung: '<b>Tagpfauenauge</b> · ruhiger Snack', bereitsPostkarte: false },
  { id: 'gartenleben-schmetterling2', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/schmetterling2.jpg', alt: 'Schwanzmeise auf einem Zweig', beschriftung: '<b>Tagpfauenauge</b> · Farbenspiel', bereitsPostkarte: false },
  ...
  { id: 'gartenleben-katze1', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/katze1.jpg', alt: 'Rotkehlchen auf einem Ast', beschriftung: '<b>schwarze Katze</b> · dunkles Versteck', bereitsPostkarte: false },
  { id: 'gartenleben-goldammer1', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/goldammer1.jpg', alt: 'Rotkehlchen auf einem Ast', beschriftung: '<b>Goldammer</b> · Solo Gesang', bereitsPostkarte: false },
  ...
  { id: 'gartenleben-schwanzmeise4', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/schwanzmeise4.jpg', alt: 'Schwanzmeise im Flug frontal in Kamera schauend', beschriftung: '<b>Schwanzmeise</b> · Moment im Flug', bereitsPostkarte: false },
  ...
  { id: 'gartenleben-singdrossel1', kategorie: 'Gartenleben', bild: 'bilder/gartenleben/singdrossel1.jpg', alt: 'singende Singdrossel auf Tannengrün', beschriftung: '<b>Singdrossel</b> · grüner Gesang', bereitsPostkarte: false },
